...
wkhtmltopdf from http://code.google.com/p/wkhtmltopdf/ or use this
direct links:

 - 64bit: http://code.google.com/p/wkhtmltopdf/downloads/detail?name=wkhtmltopdf-0.11.0_rc1-static-amd64.tar.bz2
 - 32bit: http://code.google.com/p/wkhtmltopdf/downloads/detail?name=wkhtmltopdf-0.11.0_rc1-static-i386.tar.bz2
