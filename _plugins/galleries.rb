    ...
    class GalleryTag < Liquid::Block
        ...
        def render(context)
            ...
            images.each_with_index do |image, key|
                images_html << "<div class=\"col-md-4 col-sm-6\">"
                images_html << "<a href=\"#{image['url']}\" data-lightbox=\"#{@gallery_name}\" data-title=\"#{@gallery_name}\"><img class=\"img-responsive img-portfolio img-hover\" src=\"#{image['thumbnail']}\" alt=\"#{image['caption']}\">"
                images_html << "<small class=\"gallery-caption text-muted\">#{image['caption']}</small>"
                images_html << "</a>"
                images_html << "</div>"
